...
File Path:   addons/local-octolib/lua/octolib/modules/family/client.lua
...
surface.CreateFont('octolib.family.normal', {
	font = 'Calibri',
	extended = true,
	size = 27,
	weight = 350,
...
netstream.Hook('octolib.family', function(msg)

	if msg then
		surface.PlaySound('ambient/creatures/pigeon_idle2.wav')
		local txt = markup.Parse('<font=octolib.family.normal>' .. msg .. '</font>', 600)
		local blur = Material('pp/blurscreen')
		hook.Add('RenderScreenspaceEffects', 'octolib.family', function()
		...
		hook.Add('HUDPaint', 'octolib.family', function()
		...
		hook.Remove('RenderScreenspaceEffects', 'octolib.family')
		hook.Remove('HUDPaint', 'octolib.family')
	end
