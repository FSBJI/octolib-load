...
File Path:   addons/local-octolib/lua/octolib/modules/_client/panels.lua
...
hook.Add('Think', 'octolib.panels', function()
	...
	local function paintHint(self, w, h)
		...
		draw.SimpleText(self.hint, 'octolib.hint', x, y, Color(255,255,255, al*255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	...
	function Panel:AddHint(text)
		...
		self.Think = function(self)
			self:realThink()
			thinkHint(self)
			if self.anim > 0 and isfunction(text) then self.hint = text() end
		end
